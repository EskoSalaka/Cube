...
#-------------------------------------------------------------------------------
    def getSectionCut(self, sectionIndex):
        """
        Removes and returns all the cards from section of the cardPile
...
#-------------------------------------------------------------------------------
    def getSection(self, sectionIndex):
        """
        Returns all the cards from section of the cardPile
        given by sectionIndex
        """
        
        return self._cardLabels[sectionIndex:]
