...
################################################################################
class CardList(QtWidgets.QTreeWidget):
    """A listview of cards. """
...
#-------------------------------------------------------------------------------
    def __init__(self, parent, mainFrameParent):
        ...
        self._filters = []
        self._separatorContainer = defaultdict(defaultdict)
...
#-------------------------------------------------------------------------------
    def __showContextMenu(self, pos):
        ...
        seperateMenu1 = QtWidgets.QMenu('Switch to the same card from another set', self)
        ...
        if currentItem:
            ...
            for card in sameCards:
                switchAction = QtWidgets.QAction(self)
        ...
        seperateMenu2 = QtWidgets.QMenu('Seperate cards by', self)
...
#-------------------------------------------------------------------------------
    def __createTopLevelSeperators(self):
        ...
        #-----------------------------------------------
        #Container setup.
        self._separatorContainer['Color']['W'] = self._W
        self._separatorContainer['Color']['U'] = self._U
        self._separatorContainer['Color']['B'] = self._B
        self._separatorContainer['Color']['R'] = self._R
        self._separatorContainer['Color']['G'] = self._G
        self._separatorContainer['Color']['M'] = self._M
        self._separatorContainer['Color']['C'] = self._artifacts
        
        self._separatorContainer['Type']['Creature'] = self._creatures
        self._separatorContainer['Land'] = self._lands
        self._separatorContainer['Type']['Non-Creature'] = self._nonCreatureSpells
        
        self._separatorContainer['CC'][0] = self._0CC
        self._separatorContainer['CC'][1] = self._1CC
        self._separatorContainer['CC'][2] = self._2CC
        self._separatorContainer['CC'][3] = self._3CC
        self._separatorContainer['CC'][4] = self._4CC
        self._separatorContainer['CC'][5] = self._5CC
        self._separatorContainer['CC'][6] = self._6CC

#-------------------------------------------------------------------------------
    @staticmethod
    def __mergeImages(imagePaths):
        """
    ...
    def __cardsToCCSeparators(self):
        ...
        for card in self._cards.values():
            if 'Land' in card.type:
                ...
                self._separatorContainer['CC'][card.simpleCC].addChild(card)
    ...
    def __cardsToColorSeparators(self):
        ...
        for card in self._cards.values():
            if 'Land' in card.type:
                ...
                self._separatorContainer['Color'][card.simpleColor].addChild(card)
    ...
    def __cardsToTypeSeparators(self):
        ...
        for card in self._cards.values():
            if 'Land' in card.type:
                ...
                self._separatorContainer['Type'][card.simpleType].addChild(card)
...
#-------------------------------------------------------------------------------
    def __CCToTopLevel(self):
        ...
        """
        self.addTopLevelItems(self._separatorContainer['CC'].values())
        self.addTopLevelItem(self._separatorContainer['Land'])
...
#-------------------------------------------------------------------------------
    def __typeToTopLevel(self):
        ...
        self.addTopLevelItems(self._separatorContainer['Type'].values())
        self.addTopLevelItem(self._separatorContainer['Land'])
        ...
        if card.id in self._cards.keys():
            ...
            if self._layout == 'simpleList':
                ...
                if card.simpleType == 'Land':
                    self._separatorContainer['Land'].addChild(cardItem)
                else:
                    if self._layout == 'seperateByCC':
                        self._separatorContainer['CC'][card.simpleCC].addChild(cardItem)
                    if self._layout == 'seperateByType':
                        self._separatorContainer['Type'][card.simpleType].addChild(cardItem)
                    if self._layout == 'seperateByColor':
                        self._separatorContainer['Color'][card.simpleColor].addChild(cardItem)
